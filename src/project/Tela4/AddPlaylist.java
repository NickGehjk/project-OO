...
public class AddPlaylist implements ActionListener{
	...
	public void textoNome() {
		...
		textoNome.setBounds(135, 20, 200, 30);
		frame.add(textoNome);
	}
	
	public void ano() {
		ano = new JLabel("Ano:");
		ano.setBounds(90, 70, 300, 30);
	...
	public void textoAno() {
		...
		textoAno.setBounds(135, 70, 200, 30);
		frame.add(textoAno);
	}
	
	public void add() {
		add = new JButton("Adicionar");
		add.setBounds(95, 120, 250, 30);
